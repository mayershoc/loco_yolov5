...
COMMON="--epochs 15 $BATCH"
# Flags for hyperparameter optimization using genetic algorithm.
HYP_OPT="--cache-images --evolve"

# Teacher 6: Data: LOCO_train + LOCO_synth, Pretrained: COCO, hyperparameter tuning on
python train.py --data loco_all.yaml --weights 'yolov5x.pt' --name 'evolve' $COMMON $HYP_OPT
